...
public class Principal {
    public static void main (String[] args){
        ...
        int tipoTransaccion, respuesta, transferencia, op;
        ...
        do {
        System.out.println("\n¿Desea hacer una transferencia desde alguna de las dos cuentas? (1-Sí 2-No)");
        op = sc.nextInt();
        
        if (op == 1) {
        	System.out.println("¿Desde cuál de las dos cuentas desea transferir? \n");
        	System.out.println("1- Desde la cuenta de " + cuenta1.getNombreTitular() + " a la cuenta  de " + cuenta2.getNombreTitular());
        	System.out.println("2- Desde la cuenta de " + cuenta2.getNombreTitular() + " a la cuenta de " +  cuenta1.getNombreTitular());
        	...
        	if(transferencia == 1) {
                ...
                if ((cuenta1.getSaldo()- cantidadt)<=0){
                    System.out.println ("No se puede hacer la transferencia, pues no hay saldo suficiente en la cuenta de " + cuenta1.getNombreTitular());
                } else{
                ...
                if ((cuenta2.getSaldo()- cantidadt)<=0){
                    System.out.println ("No se puede hacer la transferencia, pues no hay saldo suficiente 1en la cuenta de " + cuenta2.getNombreTitular());
                } else{
                    cuenta2.setSaldo(cuenta2.getSaldo() - cantidadt);
                    cuenta1.setSaldo(cuenta1.getSaldo()+ cantidadt);
                    System.out.println("\n------------------------------------------------------------------------------------");
